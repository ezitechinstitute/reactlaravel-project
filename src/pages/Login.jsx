...
<section className="pt-34 pb-12 2xl:pt-44">
  <div className="main-container">
    <div
      className="mx-auto w-full rounded-lg bg-[url('/images/gradient/opai-1.png')] bg-cover bg-center bg-no-repeat p-4 bg-blend-lighten lg:p-20 xl:p-28 2xl:p-39"
    >
      <div
        className="flex flex-col items-stretch justify-center gap-y-12 lg:flex-row lg:gap-x-8 2xl:gap-x-12"
      >
        <div className="w-full space-y-8 lg:w-1/2 xl:w-auto">
          <div className="space-y-3 text-center lg:text-left">
            <h2
              data-opai-animate
              data-delay="0.1"
              data-instant
              className="text-is-heading-2 font-normal text-white"
            >
              Let’s get started
            </h2>
            <p
              ...
              data-delay="0.2"
              data-instant
              className="text-tagline-2 font-inter-tight mx-auto w-full max-w-[330px] text-center font-normal text-white/60 lg:mx-0 lg:text-left"
            >
              Let’s explore how Ezitech can support your goals with AI-driven
              solutions.
            </p>
          </div>
          <div
            ...
            data-delay="0.3"
            data-instant
            className="hidden h-[450px] w-full max-w-[509px] flex-1 flex-col lg:flex"
          >
            <figure className="block h-full overflow-hidden rounded-lg">
              <img
                src="/images/opai-img-48.png"
                alt="login-hero"
        ...
        <div
          ...
          data-delay="0.3"
          data-instant
          className="bg-background-6 w-full flex-1 rounded-lg p-6 sm:p-8 md:p-11 lg:min-h-[577px] lg:w-1/2 xl:w-full xl:max-w-[460px]"
        >
          <form>
            <fieldset className="mb-4 space-y-2 md:mb-6">
              ...
              <input
                ...
                className="border-stroke-1/11 text-tagline-3 placeholder:text-tagline-3 bg-background-5 focus-visible:border-stroke-1/50 block w-full rounded-md border px-[18px] py-2.5 font-normal text-white/90 placeholder:text-white/60 focus:outline-none"
              />
            </fieldset>
            <fieldset className="mb-4 space-y-2 md:mb-6">
              <label
            ...
            <fieldset
              className="mt-6 mb-4 flex items-center justify-between gap-x-5 md:mt-8 md:mb-6"
            >
              <label className="flex cursor-pointer items-center gap-1.5">
                ...
                />
                <span
                  className="border-stroke-1/11 peer-checked:border-primary-500 relative size-5 cursor-pointer rounded-full border after:absolute after:top-1/2 after:left-1/2 after:size-3 after:-translate-x-1/2 after:-translate-y-1/2 after:rounded-full after:bg-white/50 after:opacity-0 peer-checked:after:opacity-100"
                ></span>
                <span
              ...
              <div>
                <a
                  href="#"
                  className="text-tagline-3 block flex-1 font-normal text-white/60 underline underline-offset-2"
                  >Forgot password?</a
                >
              </div>
            </fieldset>
            ...
            <button
  type="submit"
  className="group bg-background-7 hover:border-stroke-3 w-full !py-2.5 relative flex items-center justify-center gap-2 overflow-hidden rounded-xl border border-transparent px-6 py-[13px] transition-all duration-300 ease-in-out"
>
    ...
    >
      ...
      >
        <path d="M6.75 13.5L11.25 9L6.75 4.5" strokeLinecap="round" strokeLinejoin="round" />
            ...
            <p
              className="text-tagline-3 mt-4 text-center font-normal text-white/60"
            >
          ...
          <div className="py-6">
            <p
              className="text-tagline-4 relative px-2 text-center font-normal text-white/90 before:absolute before:top-1/2 before:left-[26%] before:block before:h-[1px] before:w-[43px] before:-translate-y-1/2 before:bg-[linear-gradient(270deg,rgba(210,223,240,0.40)_0%,rgba(210,223,240,0.00)_78.71%)] before:content-[''] after:absolute after:top-1/2 after:right-[26%] after:block after:h-[1px] after:w-[43px] after:-translate-y-1/2 after:rotate-180 after:bg-[linear-gradient(270deg,rgba(210,223,240,0.40)_0%,rgba(210,223,240,0.00)_78.71%)] after:content-[''] sm:before:left-[35%] sm:after:right-[35%]"
            >
              Or
            </p>
          </div>
          <div className="space-y-4 md:space-y-6">
            <a
              href="#"
              className="border-stroke-3/25 hover:bg-stroke-3/25 group flex w-full items-center justify-center gap-2 rounded-md border px-8 py-3 transition-all duration-300 ease-in-out"
            >
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <p className="text-tagline-3 mt-4 text-center font-normal text-white/60">
            Don't have an account?
            <a
              href="/signup"
              className="font-medium text-white/90 underline underline-offset-2 hover:text-white"
