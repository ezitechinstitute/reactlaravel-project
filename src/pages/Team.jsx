        ...
        <div className="sliding-swiper overflow-hidden">
          <div className="swiper-wrapper w-full items-center">
            <div className="swiper-slide">
              <figure
                className="h-[400px] max-w-[480px] overflow-hidden rounded-lg [box-shadow:70px_0_60px_0_#12161F_inset] md:h-[500px] xl:h-[650px]"
              >
            ...
            <div className="swiper-slide">
              <figure
                className="h-[400px] max-w-[480px] overflow-hidden rounded-lg [box-shadow:90px_0_110px_0_#000_inset] md:h-[500px] xl:h-[650px]"
              >
            ...
            <div className="swiper-slide">
              <figure
                className="h-[400px] max-w-[480px] overflow-hidden rounded-lg md:h-[500px] xl:h-[650px]"
              >
            ...
            <div className="swiper-slide">
              <figure
                className="h-[400px] max-w-[480px] overflow-hidden rounded-lg [box-shadow:-90px_0_110px_0_#11141D_inset] md:h-[500px] xl:h-[650px]"
              >
  ...
  <span className="font-inter-tight text-tagline-4 text-background-13/70 justify-center text-white/50 font-normal">
    Our expert
      ...
      <div className="grid grid-cols-12 items-center justify-center gap-y-8 lg:gap-x-8">
        <div data-opai-animate data-delay="0.1" className="col-span-12 md:col-span-6 lg:col-span-4">
          <div
...
>
  <figure
    className="size-full overflow-hidden rounded-lg grayscale-100 transition-all duration-400 group-hover:grayscale-0"
  >
    <img
      src="/images/opai-avatar-img-88.png"
      alt="Alex Morgan, Chief Executive Officer"
      className="size-full object-cover"
    />
  </figure>
  <a href="/team-details" className="text-center">
    <div
      className="bg-background-13/80 ease-team-ease-1 absolute bottom-[15px] left-1/2 w-[calc(100%-30px)] -translate-x-1/2 space-y-0.5 rounded-md p-5 backdrop-blur-[12px] transition-all duration-400 md:bottom-5 md:w-[calc(100%-40px)] lg:translate-y-[30%] lg:scale-[90%] lg:opacity-0 lg:group-hover:translate-y-0 lg:group-hover:scale-100 lg:group-hover:opacity-100"
    >
      <h3 className="text-manrope-heading-6 font-medium text-white/80">Alex Morgan</h3>
      <p className="text-tagline-4 text-center font-normal text-white/50">
...
>
  ...
  >
    <img
      src="/images/opai-avatar-img-110.png"
      alt="Sophia Lee, Chief Technology Officer"
      className="size-full object-cover"
    />
  </figure>
  <a href="/team-details" className="text-center">
...
>
  ...
  >
    <img
      ...
      alt="Daniel Wright, Head of Product"
      className="size-full object-cover"
    />
  </figure>
  <a href="/team-details" className="text-center">
...
>
  ...
  >
    <img
      src="/images/opai-avatar-img-112.png"
      alt="Emily Carter, Lead AI Engineer"
      className="size-full object-cover"
    />
  </figure>
  <a href="/team-details" className="text-center">
...
>
  ...
  >
    <img
      src="/images/opai-avatar-img-113.png"
  ...
  <a href="/team-details" className="text-center">
    <div
      className="bg-background-13/80 ease-team-ease-1 absolute bottom-[15px] left-1/2 w-[calc(100%-30px)] -translate-x-1/2 space-y-0.5 rounded-md p-5 backdrop-blur-[12px] transition-all duration-400 md:bottom-5 md:w-[calc(100%-40px)] lg:translate-y-[30%] lg:scale-[90%] lg:opacity-0 lg:group-hover:translate-y-0 lg:group-hover:scale-100 lg:group-hover:opacity-100"
    >
      <h3 className="text-manrope-heading-6 font-medium text-white/80">Michael Chen</h3>
      <p className="text-tagline-4 text-center font-normal text-white/50">
        Operations Manager
      </p>
    </div>
...
>
  ...
  >
    <img
      src="/images/opai-avatar-img-114.png"
      alt="Olivia Brooks, Marketing & Growth Lead"
      className="size-full object-cover"
    />
  </figure>
  <a href="/team-details" className="text-center">
    <div
      className="bg-background-13/80 ease-team-ease-1 absolute bottom-[15px] left-1/2 w-[calc(100%-30px)] -translate-x-1/2 space-y-0.5 rounded-md p-5 backdrop-blur-[12px] transition-all duration-400 md:bottom-5 md:w-[calc(100%-40px)] lg:translate-y-[30%] lg:scale-[90%] lg:opacity-0 lg:group-hover:translate-y-0 lg:group-hover:scale-100 lg:group-hover:opacity-100"
    >
      <h3 className="text-manrope-heading-6 font-medium text-white/80">Olivia Brooks</h3>
      <p className="text-tagline-4 text-center font-normal text-white/50">
