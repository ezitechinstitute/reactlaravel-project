    ...
    <>
      ...
      <main className="bg-background-5">
        <section
          ...
          style={{ paddingTop: "180px", paddingBottom: "380px" }}
        >
          <div
            className="main-container relative z-20"
            style={{ display: "flex", alignItems: "center" }}
          >
            <div
              className="grid grid-cols-1 items-center lg:grid-cols-2 w-full"
              style={{ gap: "3rem" }}
            >
              <div className="flex flex-col items-center text-center">
                <div
                  id="hero-slider-wrap"
                  className="w-full"
                  style={{ minHeight: "1.2em", marginBottom: "1.25rem" }}
                >
                  <h1
                    id="hero-slide-text"
                  ...
                  >
                    Custom Web &amp;{" "}
                    <span style={{ color: "#8d59ff" }}>Software</span>{" "}
                    Development
                  </h1>
                </div>
                ...
                <p
                  ...
                  data-delay="0.2"
                >
                  We build powerful, scalable and user-centric digital solutions
                ...
                >
                  <a
                    href="/contact"
                    className="group bg-background-7 hover:border-stroke-3 relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-xl border border-transparent px-6 py-[13px] transition-all duration-300 ease-in-out"
                  >
                    ...
                    <div className="relative mt-[1.5px] flex size-6 items-center justify-center overflow-hidden">
                      <span className="bg-background-6 absolute size-[22px] translate-x-0 rounded-full transition-all duration-400 ease-in-out">
                        <span className="stroke-background-10 absolute size-[16px] -translate-x-[8px] translate-y-0.5 scale-95 stroke-2 transition-all duration-400 ease-in-out group-hover:translate-x-6">
                          <svg
                      ...
                      <span className="stroke-background-10 absolute size-[18px] -translate-x-6 stroke-2 transition-all duration-400 ease-in-out group-hover:translate-x-0 hover:bg-white">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="18"
                          height="18"
                ...
                >
                  ...
                  <div className="text-left">
                    <p className="text-tagline-3 block font-medium text-white/90">
                      Trusted by 20k+
                    </p>
                    <p className="text-tagline-4 text-white/60">
                ...
                <div data-opai-animate data-delay="0.5">
                  <div className="hero-slide hero-slide-active flex flex-wrap gap-2 justify-center">
                    <span className="rounded-full border border-white/20 bg-white/10 px-4 py-2 text-tagline-3 font-medium text-white/80 backdrop-blur-sm">
                      Web Development
                    </span>
                    <span className="rounded-full border border-white/20 bg-white/10 px-4 py-2 text-tagline-3 font-medium text-white/80 backdrop-blur-sm">
                      Custom Software
              ...
              >
                ...
                >
                  <div
                    className="hero-orbit pointer-events-none absolute left-1/2 top-1/2 -z-0 -translate-x-1/2 -translate-y-1/2"
                    style={{ width: "118%", height: "106%" }}
                  >
                    <svg
                  ...
                  <div
                    className="pointer-events-none absolute bottom-0 left-1/2 -z-0 -translate-x-1/2 rounded-full blur-2xl"
                    style={{
                      height: "80px",
                      width: "240px",
                      background:
                        "radial-gradient(circle,rgba(141,89,255,0.7) 0%,rgba(141,89,255,0) 70%)",
                    }}
                  ></div>

                  <div className="hero-tilt relative" style={{ width: "88%" }}>
                    <div
                      className="pointer-events-none absolute inset-0 -z-10 rounded-[26px] border border-white/10 bg-white/5"
                      style={{ transform: "translate(32px,20px) scale(0.97)" }}
                    ></div>
                    <div
                      className="pointer-events-none absolute inset-0 -z-10 rounded-[26px] border border-white/10 bg-white/5"
                      style={{ transform: "translate(16px,10px) scale(0.985)" }}
                    ></div>
                    <div
                      id="hero-image-stack"
                      ...
                      style={{
                        aspectRatio: "3/4",
                        boxShadow:
                          "0 0 0 2.5px rgba(141,89,255,0.85),0 0 60px 12px rgba(141,89,255,0.55),0 0 120px 20px rgba(141,89,255,0.25),0 40px 80px -12px rgba(0,0,0,0.85)",
                      }}
                    >
                      <img
                        className="hero-img hero-img-active absolute inset-0 object-cover"
                        style={{ width: "100%", height: "100%" }}
                        src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=900&q=80"
                        alt="Web Development"
                      />
                      <img
                        className="hero-img absolute inset-0 object-cover"
                      ...
                      <div
                        ...
                        style={{
                          background:
                            "linear-gradient(160deg,rgba(141,89,255,0.15) 0%,rgba(34,126,255,0.05) 50%,rgba(141,89,255,0.2) 100%)",
                        }}
                      ></div>
                    </div>
                  </div>
          ...
          <figure className="absolute bottom-0 left-1/2 z-0 h-full w-full max-w-[1390px] -translate-x-1/2 md:-bottom-10 lg:bottom-0">
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="main-container space-y-10 sm:space-y-8 lg:space-y-18">
            <div className="space-y-1.5 text-center md:space-y-3">
              ...
              <p
                ...
                data-delay="0.3"
              >
                Trusted by 100+ businesses in retail, healthcare, tech, and
                more.
              </p>
            </div>
            <div className="md:space-y-8">
              ...
              >
                <figure className="max-md:scale-85 max-sm:scale-70">
                  <img
                    src="/images/icons/scapic-with-black-text.svg"
                    alt="clients"
                    className="w-fit"
                  />
                </figure>
                <figure className="max-md:scale-90 max-sm:scale-70">
                  <img
                    src="/images/icons/notion-with-black-text.svg"
                    alt="clients"
                    className="w-fit"
                  />
                </figure>
                <figure className="max-md:scale-90 max-sm:scale-70">
                  <img
                    src="/images/icons/lattice-with-black-text.svg"
                    alt="clients"
                    className="w-fit"
                  />
                </figure>
                <figure className="max-md:scale-90 max-sm:scale-70">
                  <img
                    src="/images/icons/hotjar-with-black-text.svg"
                    alt="clients"
                    className="w-fit"
                  />
                </figure>
                <figure className="max-md:scale-90 max-sm:scale-70">
                  <img
                    src="/images/icons/discord-with-black-text.svg"
                    alt="clients"
                    className="w-fit"
                  />
                </figure>
                <figure className="max-md:scale-90 max-sm:scale-70">
                  <img
                    src="/images/icons/stripe-with-black-text.svg"
                    alt="clients"
                    className="w-fit"
                  />
                </figure>
                <figure className="max-md:scale-90 max-sm:scale-70">
                  <img
                    src="/images/icons/spotify-with-black-text.svg"
                    alt="clients"
                    className="w-fit"
                  />
                </figure>
              ...
              >
                <figure className="max-md:scale-90 max-sm:scale-70">
                  <img
                    src="/images/icons/outreach-with-black-text.svg"
                    alt="clients"
                    className="w-fit"
                  />
                </figure>
                <figure className="max-md:scale-90 max-sm:scale-70">
                  <img
                    src="/images/icons/asana-with-black-text.svg"
                    alt="clients"
                    className="w-fit"
                  />
                </figure>
                <figure className="max-md:scale-90 max-sm:scale-70">
                  <img
                    src="/images/icons/squarespace-with-black-text.svg"
                    alt="clients"
                    className="w-fit"
                  />
                </figure>
        ...
        >
          ...
          <div className="main-container">
            <div className="grid grid-cols-1 justify-between gap-y-14 lg:grid-cols-2 lg:gap-x-20">
              ...
              <div data-opai-animate data-delay="0.4">
                <div
                  className="divide-stroke-1/11 divide-y"
                  data-image-reveal-list
                >
                  <div
                  ...
                  <a href="/service-details" className="block">
                    ...
                    >
                      ...
                      <div className="relative z-20 flex gap-x-4 gap-y-2">
                        <span className="ns-shape-1 transition-color group-hover:!text-background-13/90 text-[52px] text-white/60 duration-400 ease-in-out max-lg:scale-90"></span>
                        <div className="lg:max-w-[465px]">
                          ...
                          <p className="text-tagline-2 group-hover:text-background-13/60 transition-color font-normal text-white/60 mix-blend-color-burn duration-400 ease-in-out">
                            Engage your audience with targeted email and SMS
                            campaigns.
                          </p>
                        </div>
                      </div>
                  ...
                  <a href="/service-details" className="block">
                    ...
                    >
                      ...
                      <div className="relative z-20 flex gap-x-4 gap-y-2">
                        <span className="ns-shape-2 transition-color group-hover:!text-background-13/90 text-[52px] text-white/60 duration-400 ease-in-out max-lg:scale-90"></span>
                        <div className="lg:max-w-[465px]">
                          <h3 className="md:text-is-heading-5 font-instrument-serif transition-color group-hover:text-background-13/90 text-[26px] font-normal text-white/80 mix-blend-color-burn duration-400 ease-in-out">
                            SEO (Local &amp; Global)
                          </h3>
                          <p className="text-tagline-2 group-hover:text-background-13/60 transition-color font-normal text-white/60 mix-blend-color-burn duration-400 ease-in-out">
                            We help your business reach the right audience, near
                            or far.
                          </p>
                        </div>
                      </div>
                  ...
                  <a href="/service-details" className="block">
                    ...
                    >
                      ...
                      <div className="relative z-20 flex gap-x-4 gap-y-2">
                        <span className="ns-shape-3 transition-color group-hover:!text-background-13/90 text-[52px] text-white/60 duration-400 ease-in-out max-lg:scale-90"></span>
                        <div className="lg:max-w-[465px]">
                          <h3 className="md:text-is-heading-5 font-instrument-serif transition-color group-hover:text-background-13/90 text-[26px] font-normal text-white/80 mix-blend-color-burn duration-400 ease-in-out">
                            PPC &amp; paid media
                          </h3>
                          <p className="text-tagline-2 group-hover:text-background-13/60 transition-color font-normal text-white/60 mix-blend-color-burn duration-400 ease-in-out">
                            Boost your brand's visibility and attract
                            high-converting traffic with our PPC campaigns.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <a href="/service-details" className="block">
                    ...
                    >
                      ...
                      <div className="relative z-20 flex gap-x-4 gap-y-2">
                        <span className="ns-shape-4 transition-color group-hover:!text-background-13/90 text-[52px] text-white/60 duration-400 ease-in-out max-lg:scale-90"></span>
                        <div className="lg:max-w-[465px]">
                          <h3 className="md:text-is-heading-5 font-instrument-serif transition-color group-hover:text-background-13/90 text-[26px] font-normal text-white/80 mix-blend-color-burn duration-400 ease-in-out">
                            Social media ads
                          </h3>
                          <p className="text-tagline-2 group-hover:text-background-13/60 transition-color font-normal text-white/60 mix-blend-color-burn duration-400 ease-in-out">
                            Reach your target audience with tailored social
                            media campaigns.
                          </p>
                        </div>
                      </div>
                  ...
                  <a href="/service-details" className="block">
                    ...
                    >
                      ...
                      <div className="relative z-20 flex gap-x-4 gap-y-2">
                        <span className="ns-shape-5 transition-color group-hover:!text-background-13/90 text-[52px] text-white/60 duration-400 ease-in-out max-lg:scale-90"></span>
                        <div className="lg:max-w-[465px]">
                          <h3 className="md:text-is-heading-5 font-instrument-serif transition-color group-hover:text-background-13/90 text-[26px] font-normal text-white/80 mix-blend-color-burn duration-400 ease-in-out">
          ...
          <div className="main-container relative z-20 space-y-12 md:space-y-17.5">
            <div className="flex flex-col gap-y-1.5 md:gap-y-14 lg:flex-row lg:items-end lg:justify-between">
              ...
              <p
                ...
                data-delay="0.3"
              >
                We don’t run “random campaigns.” We build repeatable
                systems—powered by AI, guided by strategy, and measured with
                clean reporting—so you can scale with confidence.
              </p>
            </div>
            ...
            >
              <div className="bg-background-6 group border-stroke-1/11 why-choose-us-card relative flex min-h-[430px] flex-col justify-between gap-2.5 overflow-hidden p-8 max-lg:border-b md:min-h-[471px] md:border-r lg:rounded-l-lg">
                <div className="pointer-events-none absolute -top-[16%] -right-[26%] z-0 h-[256px] w-[306px] -translate-y-[20%] rounded-[306px] bg-linear-[190deg,#744FB3_52.06%,#FF9C7B_92.8%] opacity-0 blur-[50px] transition-all duration-500 ease-in-out select-none group-hover:translate-y-0 group-hover:opacity-100"></div>
              ...
              <div className="bg-background-6 group border-stroke-1/11 why-choose-us-card relative flex min-h-[430px] flex-col justify-between gap-2.5 overflow-hidden p-8 max-lg:border-b md:min-h-[471px] md:border-r">
                <div className="pointer-events-none absolute -top-[16%] -right-[26%] z-0 h-[256px] w-[306px] -translate-y-[20%] rounded-[306px] bg-linear-[190deg,#744FB3_52.06%,#FF9C7B_92.8%] opacity-0 blur-[50px] transition-all duration-500 ease-in-out select-none group-hover:translate-y-0 group-hover:opacity-100"></div>
              ...
              <div className="bg-background-6 group border-stroke-1/11 why-choose-us-card relative flex min-h-[430px] flex-col justify-between gap-2.5 overflow-hidden p-8 md:min-h-[471px] md:border-r lg:rounded-r-lg">
                <div className="pointer-events-none absolute -top-[16%] -right-[26%] z-0 h-[256px] w-[306px] -translate-y-[20%] rounded-[306px] bg-linear-[190deg,#744FB3_52.06%,#FF9C7B_92.8%] opacity-0 blur-[50px] transition-all duration-500 ease-in-out select-none group-hover:translate-y-0 group-hover:opacity-100"></div>
        ...
        <section className="bg-white pt-16 pb-16 md:pt-24 md:pb-28 lg:pt-28 lg:pb-36 xl:pt-36 xl:pb-44 2xl:pt-44">
          <div className="md:main-container">
            ...
            >
              <div className="absolute -top-7 left-[5%] z-2 h-10 w-full bg-linear-[0deg,white_0%,white_100%] blur-[5px]"></div>
              ...
              <div className="absolute bottom-[6%] left-1/2 w-[800px] -translate-x-1/2 md:w-[899px]">
                <div className="integration-circle-animation">
                  <svg
                    viewBox="-30 -30 1520 1520"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    ...
                    <g transform="translate(1063.35 84.09)">
                      ...
                      />
                      <image
                        href="/images/icons/claude-ai.svg"
                        x="17"
                        y="17"
                        width="38"
                        height="38"
                    ...
                    <g transform="translate(1331.15 346.90)">
                      ...
                      />
                      <image
                        href="/images/icons/deepseek.svg"
                        x="17"
                        y="17"
                        width="38"
                        height="38"
                    ...
                    <g transform="translate(1398.06 892.35)">
                      ...
                      />
                      <image
                        href="/images/icons/mistral-ai.svg"
                        x="17"
                        y="17"
                        width="38"
                        height="38"
                    ...
                    <g transform="translate(1210.65 1217.23)">
                      ...
                      />
                      <image
                        href="/images/icons/perplexity-ai.svg"
                        x="17"
                        y="17"
                        width="38"
                        height="38"
          ...
          <div className="main-container">
            <div className="space-y-12 md:space-y-20">
              ...
              <div className="grid grid-cols-12 gap-y-8 md:gap-y-14 lg:gap-y-20">
                <div className="col-span-12">
                  <div className="group relative h-[640px]">
                    ...
                    <div className="pointer-events-none absolute inset-0 z-2 rounded-lg bg-linear-[0deg,rgba(0,0,0,0.45)_0%,rgba(0,0,0,0.45)_100%] opacity-0 transition-all duration-500 ease-in-out group-hover:opacity-100"></div>
                      ...
                      <a href="/case-study-details">
                        <div className="w-full md:w-[80%] lg:w-full">
                          ...
                          <p className="text-tagline-3 md:text-tagline-2 font-inter-tight text-white/50">
                            AI delivery optimization cut times, reduced
                            failures, and boosted conversions.
                          </p>
                        </div>
                      </a>
                    ...
                    >
                      <a href="/case-study-details">
                        <div className="w-full md:w-[80%] lg:w-full">
                          ...
                          <p className="text-tagline-3 md:text-tagline-2 font-inter-tight text-white/50">
                            AI campaigns increased leads, cut fraud, and grew
                            LTV.
                          </p>
                        </div>
                      </a>
                    ...
                    >
                      <a href="/case-study-details">
                        <div className="w-full md:w-[80%] lg:w-full">
                          ...
                          <p className="text-tagline-3 md:text-tagline-2 font-inter-tight text-white/50">
                            AI recommendations boosted revenue and repeat
                            buyers.
                          </p>
                        </div>
                      </a>
              ...
              >
                ...
                >
                  <div className="h-full max-h-5 overflow-hidden">
                    <span className="font-ibm-plex-mono text-tagline-2 text-background-7 {=$class} block -translate-y-0.5 leading-[1.4] font-medium text-nowrap transition-transform duration-500 ease-in-out group-hover:-translate-y-[105%]">
                      More success stories
                    </span>
                    <span className="font-ibm-plex-mono text-background-7 text-tagline-2 block leading-[1.4] font-medium text-nowrap transition-transform duration-500 ease-in-out group-hover:-translate-y-[105%]">
                      More success stories
                    </span>
                  </div>
          ...
          <div className="main-container space-y-10 md:space-y-28">
            ...
            <div className="space-y-1.5 text-center md:space-y-3">
              ...
              <p
                ...
                data-delay="0.4"
              >
                Businesses trust Ezitech because of its proven ability to
                deliver data-driven insights that drive real results. With
                advanced AI technology, robust security protocols,
              </p>
            </div>
            ...
            <div className="sliding-swiper overflow-hidden">
              <div className="swiper-wrapper w-full items-center">
                <div className="swiper-slide">
                  <figure className="h-[400px] max-w-[480px] overflow-hidden rounded-lg [box-shadow:70px_0_60px_0_#12161F_inset] md:h-[500px] lg:h-[650px]">
                    <img
                ...
                <div className="swiper-slide">
                  <figure className="h-[400px] max-w-[480px] overflow-hidden rounded-lg [box-shadow:90px_0_110px_0_#000_inset] md:h-[500px] lg:h-[650px]">
                    <img
                ...
                <div className="swiper-slide">
                  <figure className="h-[400px] max-w-[480px] overflow-hidden rounded-lg [box-shadow:-90px_0_110px_0_#11141D_inset] md:h-[500px] lg:h-[650px]">
                    <img
          ...
          <div className="main-container space-y-10 md:space-y-20">
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
              <div data-opai-animate data-delay="0.3">
                <h2 className="text-is-heading-3 md:text-is-heading-2 lg:text-is-heading-1 webkit-bg-clip-text bg-linear-[180deg,#FFF_0%,rgba(18,32,31,0.00)_100%] bg-clip-text font-normal text-transparent">
                  1
                </h2>
              ...
              <div data-opai-animate data-delay="0.4">
                ...
                <p className="text-tagline-2 font-inter-tight text-white/60 lg:max-w-[260px]">
                  Co-build a roadmap that blends predictive insights with human
                  creativity.
                </p>
              </div>
              <div data-opai-animate data-delay="0.5">
                ...
                <p className="text-tagline-2 font-inter-tight text-white/60 lg:max-w-[260px]">
                  Deploy experiences, run iterative experiments, and scale what
                  works.
                </p>
              </div>
              <div data-opai-animate data-delay="0.6">
                ...
                <p className="text-tagline-2 font-inter-tight text-white/60 lg:max-w-[260px]">
                  Stay in the loop with transparent reporting and optimization
                  insights.
                </p>
              </div>
            </div>
        ...
        <section className="bg-background-5 relative overflow-hidden pt-14 pb-14 md:pt-22 md:pb-28 lg:pt-28 lg:pb-36 xl:pb-40 2xl:pb-44">
          ...
          <div className="gradient-hidden">
            <div
              className="cards-marquee-container relative z-20"
              data-opai-animate
              data-delay="0.3"
            >
              <div className="flex items-center justify-center gap-8">
                <div className="relative ml-8 flex min-h-[329px] w-full min-w-[320px] flex-col items-center rounded-lg bg-white px-4 pt-8 pb-8 md:min-h-[370px] md:min-w-[332px] md:px-8 md:pt-14">
                  <div className="max-h-full space-y-4 text-center">
                    ...
                    <p className="text-tagline-2 text-background-13/60 font-normal text-wrap">
                      Committed, innovative, and results-oriented—exactly what
                      we needed. Their creative strategies consistently
                      introduce new concepts. With a deep dedication to quality.
                    </p>
                  </div>
                  ...
                  <div className="absolute bottom-4 left-1/2 mt-[5px] -translate-x-1/2 space-y-2 text-center md:bottom-6">
                    ...
                    <blockquote className="space-y-0.5">
                      <h3 className="text-is-heading-6 text-background-6 font-normal">
                        Lena Torres
                      </h3>
                ...
                <div className="relative flex min-h-[329px] w-full min-w-[320px] flex-col items-center rounded-lg bg-white px-4 pt-8 pb-8 md:min-h-[370px] md:min-w-[332px] md:px-8 md:pt-14">
                  <div className="max-h-full space-y-4 text-center">
                    <div className="flex items-center justify-center gap-1">
                      <span>
                        <span className="flex items-center justify-start gap-x-1">
                    ...
                    <p className="text-tagline-2 text-background-13/60 font-normal text-wrap">
                      "The team's expertise and hands-on approach made the
                      entire integration seamless and surprisingly fast. Highly
                      recommend!"
                    </p>
                  </div>
                ...
                <div className="relative flex min-h-[329px] w-full min-w-[320px] flex-col items-center rounded-lg bg-white px-4 pt-8 pb-8 md:min-h-[370px] md:min-w-[332px] md:px-8 md:pt-14">
                  <div className="max-h-full space-y-4 text-center">
                    ...
                    <p className="text-tagline-2 text-background-13/60 font-normal text-wrap">
                      "From day one, Ezitech felt like an extension of our
                      internal team. Their tools and support are truly
                      next-level."
                    </p>
                  </div>
                ...
                <div className="relative flex min-h-[329px] w-full min-w-[320px] flex-col items-center rounded-lg bg-white px-4 pt-8 pb-8 md:min-h-[370px] md:min-w-[332px] md:px-8 md:pt-14">
                  <div className="max-h-full space-y-4 text-center">
                    ...
                    <p className="text-tagline-2 text-background-13/60 font-normal text-wrap">
                      "We went from idea to execution in weeks—not months. The
                      automation is saving us countless hours every month."
                    </p>
                  </div>
                ...
                <div className="relative flex min-h-[329px] w-full min-w-[320px] flex-col items-center rounded-lg bg-white px-4 pt-8 pb-8 md:min-h-[370px] md:min-w-[332px] md:px-8 md:pt-14">
                  <div className="max-h-full space-y-4 text-center">
                    ...
                    <p className="text-tagline-2 text-background-13/60 font-normal text-wrap">
                      "What impressed me most was the flexibility. Ezitech
                      adapted to our workflow instead of forcing us to change."
                    </p>
                  </div>
                ...
                <div className="relative flex min-h-[329px] w-full min-w-[320px] flex-col items-center rounded-lg bg-white px-4 pt-8 pb-8 md:min-h-[370px] md:min-w-[332px] md:px-8 md:pt-14">
                  <div className="max-h-full space-y-4 text-center">
                    ...
                    <p className="text-tagline-2 text-background-13/60 font-normal text-wrap">
                      "The onboarding was seamless and the team was incredibly
                      responsive. Now, our marketing runs smoother and results
                      are up by 33%!"
                    </p>
                  </div>
                ...
                <div className="relative flex min-h-[329px] w-full min-w-[320px] flex-col items-center rounded-lg bg-white px-4 pt-8 pb-8 md:min-h-[370px] md:min-w-[332px] md:px-8 md:pt-14">
                  <div className="max-h-full space-y-4 text-center">
                    ...
                    <p className="text-tagline-2 text-background-13/60 font-normal text-wrap">
                      "Ezitech gave us an edge in campaign optimization—A/B
                      testing used to take weeks; now it’s just days."
                    </p>
                  </div>
                ...
                <div className="relative flex min-h-[329px] w-full min-w-[320px] flex-col items-center rounded-lg bg-white px-4 pt-8 pb-8 md:min-h-[370px] md:min-w-[332px] md:px-8 md:pt-14">
                  <div className="max-h-full space-y-4 text-center">
                    ...
                    <p className="text-tagline-2 text-background-13/60 font-normal text-wrap">
                      "The insights dashboard is exactly what we needed. It
                      makes ROI tracking effortless and helps us double-down on
                      what works."
                    </p>
                  </div>
                ...
                <div className="relative flex min-h-[329px] w-full min-w-[320px] flex-col items-center rounded-lg bg-white px-4 pt-8 pb-8 md:min-h-[370px] md:min-w-[332px] md:px-8 md:pt-14">
                  <div className="max-h-full space-y-4 text-center">
                    ...
                    <p className="text-tagline-2 text-background-13/60 font-normal text-wrap">
                      "I was skeptical at first, but the productivity boost is
                      obvious. Our team can spend more time on strategy, less on
                      grunt work."
                    </p>
                  </div>
          ...
          <div className="main-container space-y-10 md:space-y-17.5">
            <div className="space-y-1.5 text-center md:space-y-3">
              ...
              <p
                ...
                data-delay="0.3"
              >
                Discover expert tips, industry trends, and actionable strategies
                to power your growth with Ezitech.
              </p>
            </div>
            ...
            <div
              ...
              data-delay="0.4"
            >
              <div className="partner-ship-card active-partner-ship-card h-[420px] md:h-[333px]">
                <a
                  href="/team-details"
                    ...
                    <div className="flex justify-between gap-21">
                      <div>
                        ...
                        <p className="partner-ship-description text-tagline-2 font-inter-tight line-clamp-5 text-white/60 lg:line-clamp-3 xl:line-clamp-5">
                          ...
                          marketing strategies that leverage Meta's platforms to
                          drive your business growth. Our tailored approaches
                          and expert insights enhance your advertising efforts
                          and broaden your audience reach, ensuring you remain a
                          strong contender in the online marketing landscape.
                        </p>
                      </div>
                      <div>
                        <svg
                    ...
                    <div className="flex justify-between gap-21">
                      <div>
                        ...
                        <p className="partner-ship-description text-tagline-2 font-inter-tight line-clamp-5 text-white/60 lg:line-clamp-3 xl:line-clamp-5">
                          ...
                          digital marketing strategies that leverage Google's
                          platforms to drive your business growth. Our tailored
                          approaches and expert insights enhance your
                          advertising efforts and broaden your audience reach,
                          ensuring you remain a strong contender in the online
                          marketing landscape.
                        </p>
                      </div>
                      <div>
                  ...
                  <div className="relative z-10 space-y-8">
                    ...
                    <div className="flex justify-between gap-21">
                      <div>
                        ...
                        <p className="partner-ship-description text-tagline-2 font-inter-tight line-clamp-5 text-white/60 lg:line-clamp-3 xl:line-clamp-5">
                          As a Klaviyo Partner, we specialize in digital
                          marketing strategies that leverage Klaviyo's platforms
                          to drive your business growth. Our tailored approaches
                          and expert insights enhance your email marketing
                          efforts and broaden your audience reach, ensuring you
                          remain a strong contender in the online marketing
                          landscape.
                        </p>
                      </div>
                      <div>
            ...
            >
              ...
              >
                <div className="h-full max-h-5 overflow-hidden">
                  <span className="font-ibm-plex-mono text-tagline-2 text-background-7 w-[85%] md:w-auto block -translate-y-0.5 leading-[1.4] font-medium text-nowrap transition-transform duration-500 ease-in-out group-hover:-translate-y-[105%]">
                    Let’s get started
                  </span>
                  <span className="font-ibm-plex-mono text-background-7 text-tagline-2 block leading-[1.4] font-medium text-nowrap transition-transform duration-500 ease-in-out group-hover:-translate-y-[105%]">
                    Let’s get started
        ...
        <section className="bg-background-7 py-14 md:py-24 lg:py-28 xl:py-36 2xl:py-44">
          <div className="main-container space-y-10 md:space-y-14">
            ...
            <div className="hidden lg:block">
              <div className="flex items-start justify-center overflow-hidden max-lg:flex-wrap max-lg:gap-y-9 md:space-x-[30px]">
                <article
                ...
                >
                  ...
                  <div className="space-y-4 px-2">
                    <p className="text-tagline-5 text-background-13/80 font-normal">
                      28/6/2025
                    </p>
                    <div className="space-y-2">
                      <div className="flex flex-wrap items-center gap-2">
                        <span className="bg-background-13/5 text-tagline-4 text-background-13/50 rounded-full px-3 py-1 font-normal">
                          Ads
                        </span>
                        <span className="bg-background-13/5 text-tagline-4 text-background-13/50 rounded-full px-3 py-1 font-normal">
                          Performance
                ...
                >
                  ...
                  <div className="space-y-4 px-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <a href="/blog-details" className="blog-title-black">
                        <h3 className="text-is-heading-5 text-background-13 font-normal">
                          Landing page CRO checklist: fix leaks and lift
                          conversions
                        </h3>
                      </a>
                    </div>
            ...
            <div className="space-y-14 pb-9">
              ...
              <div className="space-y-3">
                ...
                <p
                  ...
                  data-delay="0.2"
                >
                  No guesswork. We use AI + proven marketing systems to scale
                  ads, SEO, and conversion.
                </p>
              </div>
