                  ...
                  >
                    <h3 className="font-instrument-serif text-is-heading-3 flex items-center justify-center text-white/90">
                      <span
                        ...
                        data-speed="2000"
                        data-interval="200"
                        data-rooms={String(stat.number).length}
                        data-height-space={stat.heightSpace}
                      >
                        {stat.number}
                      </span>
                      {stat.suffix}
            ...
            <div className="space-y-14 md:space-y-[70px]">
              ...
              >
                {CASE_STUDIES.map((study) => (
                  <div className="col-span-12" key={study.title}>
                            ...
                            <Fragment key={metric.label}>
                              ...
                              <div>
                                <h4 className="text-is-heading-6 flex items-center font-normal text-white/90">
                                  <span
                                    data-counter
                                    data-number={metric.number}
                                    data-speed="2000"
                                    data-interval="200"
                                    data-rooms={String(metric.number).length}
                                    data-height-space="3"
                                  >
                                    {metric.number}
                                  </span>
          ...
          <div className="main-container">
            <div className="space-y-14 pb-9">
              <div className="flex items-center justify-center gap-x-2">
                {MARKETING_AVATARS.map((avatar, i) => (
                  <img
                    key={avatar.alt}
                    data-opai-avatar
                    data-avatar-delay={`0.${i + 1}`}
