...
export default function TeamDetails() {
  return (
    <>
      <SEO title="Team Details" url="/team-details" />
...
<section className="pt-28 md:pt-39">
  <div className="main-container">
    <div
      ...
      data-delay="0.1"
      data-instant
      className="border-stroke-3/18 relative mx-auto w-full max-w-[850px] overflow-hidden rounded-xl border"
    >
      ...
      >
        <figure className="size-[552px] overflow-hidden">
          <img src="/images/opai-img-47.svg" alt="gradient bg" className="size-full object-cover" />
        </figure>
      </div>
      ...
      <div className="relative z-10 space-y-4">
        <div
          className="mx-auto flex h-[500px] w-full items-end overflow-hidden rounded-xl bg-[url('/images/opai-img-46.png')] bg-cover bg-center md:h-[600px] lg:h-[770px]"
        ></div>
        ...
        >
          <div
            className="flex flex-col items-center justify-between gap-x-4 gap-y-6 md:flex-row md:gap-y-0"
          >
            
            <div
              className="border-stroke-3/18 basis-1/2 space-y-4 border-b pb-4 md:border-r md:border-b-0 md:pb-0"
            >
              <div className="space-y-1">
                ...
                <h2
                  data-opai-animate
                  data-delay="0.3"
                  className="font-instrument-serif text-is-heading-5 font-normal text-white/90"
                >
                  Mia Thompson
                </h2>
              </div>
              ...
              <p
                data-opai-animate
                data-delay="0.4"
                className="font-inter-tight text-tagline-3 mr-5 font-normal text-white/60 lg:mr-0"
              >
                Mia transforms complex data into actionable insights that drive smarter decisions.
              </p>
            </div>
            ...
            <div className="w-full space-y-5.5 md:basis-1/2">
              <div className="space-y-2">
                ...
                <p
                  data-opai-animate
                  data-delay="0.4"
                  className="font-inter-tight text-tagline-3 font-normal text-white/60"
                >
                  <span className="mb-1">mia.thompson@company.com</span> <br />
                  <span>+1 (368) 567 89 54</span>
                </p>
              </div>
...
<section className="pb-20 md:pb-30 lg:pb-44">
  <div className="main-container">
    <div data-opai-animate data-delay="0.1" className="team-details">
      <h3>Experience & education</h3>
      <p>2009 – 2013</p>

      <h4>University of California, Berkeley</h4>
      <p>
        Bachelor’s degree in Computer Science with a focus on data analysis and applied statistics.
        Built a strong foundation in algorithms, data modeling, and analytical problem-solving
        through hands-on projects and research-driven coursework.
      </p>
      ...
      <h4>Microsoft</h4>
      <p>
        Worked as a Data Analyst within cross-functional product teams, analyzing large-scale user
        data to improve product performance and user engagement. Contributed to dashboard
        development, reporting automation, and data-driven decision processes.
      </p>
      ...
      <h4>Your Company</h4>
      <p>
        Currently leading data initiatives focused on business intelligence and operational
        insights. Collaborating with engineering and product teams to design scalable data
        pipelines, implement analytics frameworks, and support strategic decision-making.
      </p>

      <h3>Key responsibilities</h3>
      <ul>
        <li>Analyze and interpret complex datasets to support business decisions.</li>
        <li>Design and maintain dashboards and performance reports.</li>
        <li>Collaborate with product and engineering teams on data-driven initiatives.</li>
      </ul>
    </div>
  </div>
</section>
