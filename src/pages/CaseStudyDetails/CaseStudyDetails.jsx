...
export default function CaseStudyDetails() {
  return (
    <>
      <SEO title="Case Study" url="/case-study-details" />
    ...
    <div className="space-y-[70px]">
      <div className="space-y-3 text-center">
        <h2
          ...
          data-delay="0.1"
          data-instant
          className="font-instrument-serif text-is-heading-4 md:text-is-heading-3 lg:text-is-heading-2 mx-auto w-full max-w-[982px] font-normal text-white/90"
        >
          Client TechNexa: Streamlining operations with AI-Powered workflow Automation
        </h2>
        <p
          data-opai-animate
          data-delay="0.2"
        ...
        >
          From automating complex workflows to delivering human-like support, Ezitech powers
          transformation at every level.
        </p>
      </div>

      
      <div data-opai-animate data-delay="0.3" data-instant className="bg-background-6 rounded-2xl">
        <div className="grid grid-cols-12 items-center gap-x-2">
          
          <div data-opai-animate data-delay="0.3" data-instant className="col-span-6 h-full">
            <figure className="size-full overflow-hidden rounded-xl">
              <img
                src="/images/opai-img-11.png"
                alt="case study details img"
          ...
          <div className="col-span-6 h-full">
            ...
            >
              ...
              <figure
                ...
                data-delay="0.5"
                data-instant
                className="h-1/2 w-full overflow-hidden rounded-xl"
              >
                <img
                  src="/images/opai-img-13.png"
                  alt="case study details img"
                  className="size-full object-cover"
                />
              </figure>
        ...
        <div
          data-opai-animate
          data-delay="0.1"
          className="mx-auto max-w-[850px] space-y-[70px] px-5 pb-28 lg:px-0"
        >
          <div className="case-study-details-markdown">
            <h3>Challenge:</h3>
            <p>
              As TechNexa grew rapidly, manual workflows couldn’t keep up. Employees were bogged
              down by repetitive tasks, leading to delays, rising costs, and burnout. To scale
              efficiently and focus on strategic work, TechNexa needed a smarter, more automated
              solution.
            </p>

            <h3>Solution:</h3>
            <p>
              Ezitech deployed a customized AI-driven workflow automation system tailored to
              TechNexa’s operations. By leveraging machine learning and RPA, repetitive tasks like
              data entry, reporting, and client onboarding were fully automated.
              <span>
                The solution integrated seamlessly with existing tools, ensuring a smooth
                transition. With real-time updates, smart task prioritization, and actionable
                insights, the team stayed focused, efficient, and aligned with business goals.
              </span>
            </p>

            <h3>Results:</h3>
            <p>Ezitech’s solution delivered measurable improvements:</p>
            <ul>
              <li>
                <span> 75% Task Automation: </span> Manual, repetitive tasks were automated, freeing
                up employee time for strategic work.
              </li>
              <li>
                <span> 50% Faster Delivery Times: </span> Streamlined workflows led to quicker
                project completions.
              </li>
              <li>
                <span> 20% Cost Savings: </span> Reduced operational expenses with fewer resources
                required for redundant tasks.
              </li>
            </ul>

            <h3>Employee satisfaction:</h3>
            <p>
              Employees reported a significant improvement in job satisfaction as they shifted focus
              to high-impact, creative tasks. The automation system also ensured consistency and
              accuracy, reducing errors and enhancing overall output quality.
            </p>

            <h3>What they said:</h3>
            <p>
              "Ezitech revolutionized our operations. With workflow automation, we’re faster, leaner,
              and more efficient than ever before. Our team loves how much easier their jobs have
              become!" – TechNexa
            </p>
          </div>
...
<section className="bg-background-7 pb-20 md:pb-30 lg:pb-44">
    ...
    <div className="space-y-[70px]">
      <div className="space-y-4 text-center">
        <div data-opai-animate data-delay="0.1">
          <span className="fill-opai-blue justify-center text-black flex items-center gap-x-1">
  ...
  <span className="font-inter-tight text-tagline-4 text-background-13/70 justify-center text-black font-normal">
    Achievement
  </span>
</span>
      ...
      <div className="grid grid-cols-12 gap-y-6 md:gap-x-8 md:gap-y-0">
        ...
        <div
          data-opai-animate
          data-delay="0.1"
          className="bg-background-6 col-span-12 space-y-6 rounded-xl p-8 md:col-span-4"
        >
          <span
            className="ns-shape-37 inline-block text-[48px] text-white/90"
          ></span>
          <div>
            <h3
              className="font-instrument-serif text-is-heading-5 font-normal text-nowrap text-white/90"
            >
              Client suthyapa
            </h3>
            <p
              className="font-inter-tight text-tagline-2 line-clamp-2 font-normal text-white/60"
            >
              Enhancing customer service through automation is a game changer.
            </p>
          </div>
          <div>
            <a
  href="/case-study-details"
  className="group bg-background-7 hover:border-stroke-3 w-fit !py-2.5 !px-4 relative flex items-center justify-center gap-2 overflow-hidden rounded-xl border border-transparent px-6 py-[13px] transition-all duration-300 ease-in-out"
>
  ...
  <div className="relative mt-[1.5px] flex size-6 items-center justify-center overflow-hidden">
    ...
    >
      ...
      >
        ...
        >
          <span
            className="ns-shape-38 inline-block text-[48px] text-white/90"
          ></span>
          <div>
            <h3
              className="font-instrument-serif text-is-heading-5 font-normal text-nowrap text-white/90"
            ...
            <p
              className="font-inter-tight text-tagline-2 line-clamp-2 font-normal text-white/60"
            >
              Driving 60% Revenue Growth with Personalized Campaigns
            </p>
          </div>
          <div>
            <a
  ...
  <div className="relative mt-[1.5px] flex size-6 items-center justify-center overflow-hidden">
    ...
    >
      ...
      >
        ...
        >
          <span
            className="ns-shape-39 inline-block text-[48px] text-white/90"
          ></span>
          <div>
            <h3
              className="font-instrument-serif text-is-heading-5 font-normal text-nowrap text-white/90"
            ...
            <p
              className="font-inter-tight text-tagline-2 line-clamp-2 font-normal text-white/60"
            >
              Cutting Project Delivery Times by 40% with AI-Driven Analytics
            </p>
          </div>
          <div>
            <a
