...
export default function CaseStudy() {
  return (
    <>
      <SEO title="Case Studies" url="/case-study" />
  ...
  <span className="font-inter-tight text-tagline-4 text-background-13/70 justify-center text-white font-normal">
    By the Numbers
      ...
      <div
        data-opai-animate
        data-delay="0.3"
        className="bg-background-6 flex flex-col items-center justify-center gap-y-8 rounded-xl p-8 md:flex-row md:gap-y-0"
      >
        
        <div
          data-opai-animate
          data-delay="0.3"
          className="border-stroke-3/20 w-full border-r-0 px-10.5 py-8 text-center md:border-r md:last:border-r-0"
        >
          <h3
            className="font-instrument-serif text-is-heading-3 flex items-center justify-center text-white/90"
          >
            <span
              data-counter
              data-number="83"
          ...
          <p className="font-inter-tight text-tagline-2 text-white/60">
            Real-time support satisfaction across 100+ countries
          </p>
        </div>
        ...
        >
          ...
          <p className="font-inter-tight text-tagline-2 text-white/60">
            Improvement in agent resolution efficiency
          </p>
        </div>
        ...
        >
          ...
          <p className="font-inter-tight text-tagline-2 text-white/60">
            Customer interactions automated monthly
          </p>
        </div>
        ...
        >
          ...
          <p className="font-inter-tight text-tagline-2 text-white/60">
            Many companies choose to collaborate with us
          </p>
        </div>
      </div>
    </div>
  ...
  <span className="font-inter-tight text-tagline-4 text-background-13/70 justify-center text-black font-normal">
    Case Studies
        ...
        <h2
          data-opai-animate
          data-delay="0.2"
          className="text-is-heading-4 md:text-is-heading-3 lg:text-is-heading-2 text-background-13/90 mx-auto w-full max-w-[670px] text-center font-normal"
        >
      ...
      <div
        data-opai-animate
        data-delay="0.3"
        className="grid grid-cols-12 gap-y-[70px]"
      >
            ...
            >
              <a href="/case-study-details">
                <div className="w-full md:w-[80%] lg:w-full">
                  ...
                  <p
                    className="text-tagline-3 md:text-tagline-2 font-inter-tight text-white/50"
                  >
                    AI content tagging and discovery drove engagement and
                    reduced churn.
                  </p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-tagline-3 text-white/60">Lower churn</p>
                </div>
                <div className="bg-stroke-1/10 hidden h-[60px] w-px md:block"></div>
                <div>
                  <h4
                  ...
                  <p className="text-tagline-3 text-white/60">Engagement lift</p>
                </div>
              </div>
            </div>
          </div>
            ...
            >
              <a href="/case-study-details">
                <div className="w-full md:w-[80%] lg:w-full">
                  ...
                  <p
                    className="text-tagline-3 md:text-tagline-2 font-inter-tight text-white/50"
                  >
                    AI lead scoring and outreach increased pipeline and closed
                    deals.
                  </p>
                </div>
              </a>
              ...
              >
                <div>
                  ...
                  <p className="text-tagline-3 text-white/60">Lead accuracy</p>
                </div>
                <div className="bg-stroke-1/10 hidden h-[60px] w-px md:block"></div>
                <div>
                  <h4
                  ...
                  <p className="text-tagline-3 text-white/60">More pipeline</p>
                </div>
                <div className="bg-stroke-1/10 hidden h-[60px] w-px md:block"></div>
                <div>
                  <h4
            ...
            >
              <a href="/case-study-details">
                <div className="w-full md:w-[80%] lg:w-full">
                  ...
                  <p
                    className="text-tagline-3 md:text-tagline-2 font-inter-tight text-white/50"
                  >
                    Predictive inventory and demand forecasting cut waste and
                    boosted margins.
                  </p>
                </div>
              </a>
              ...
              >
                <div>
                  ...
                  <p className="text-tagline-3 text-white/60">Less waste</p>
                </div>
                <div className="bg-stroke-1/10 hidden h-[60px] w-px md:block"></div>
                <div>
                  <h4
                  ...
                  <p className="text-tagline-3 text-white/60">Margin improvement</p>
                </div>
                <div className="bg-stroke-1/10 hidden h-[60px] w-px md:block"></div>
                <div>
                  <h4
                  ...
                  <p className="text-tagline-3 text-white/60">Forecast accuracy</p>
                </div>
              </div>
            </div>
          </div>
