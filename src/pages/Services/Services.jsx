...
>
  ...
  >
    ...
    <img src="/images/opai-img-57.png" alt="" />
    <img src="/images/opai-img-58.png" alt="" />
    <img src="/images/opai-img-50.png" alt="" />
  </div>
  ...
  <div className="media-container relative size-full overflow-hidden rounded-xl" data-image-reveal-container></div>
          ...
          >
            ...
            >
              ...
              <div className="relative z-20 flex gap-x-4 gap-y-2">
                <span
                  className="ns-shape-6 transition-color group-hover:!text-background-13/90 text-[52px] text-white/60 duration-400 ease-in-out max-lg:scale-90"
                ></span>
                <div className="lg:max-w-[465px]">
                  <h3
                    className="md:text-is-heading-5 font-instrument-serif transition-color group-hover:text-background-13/90 text-[26px] font-normal text-white/80 mix-blend-color-burn duration-400 ease-in-out"
          ...
          >
            ...
            >
              ...
              <div className="relative z-20 flex gap-x-4 gap-y-2">
                <span
                  className="ns-shape-7 transition-color group-hover:!text-background-13/90 text-[52px] text-white/60 duration-400 ease-in-out max-lg:scale-90"
                ></span>
                <div className="lg:max-w-[465px]">
                  <h3
                    className="md:text-is-heading-5 font-instrument-serif transition-color group-hover:text-background-13/90 text-[26px] font-normal text-white/80 mix-blend-color-burn duration-400 ease-in-out"
                  ...
                  <p
                    className="text-tagline-2 group-hover:text-background-13/60 transition-color max-w-[398px] font-normal text-white/60 mix-blend-color-burn duration-400 ease-in-out"
                  >
          ...
          >
            ...
            >
              ...
              <div className="relative z-20 flex gap-x-4 gap-y-2">
                <span
                  className="ns-shape-8 transition-color group-hover:!text-background-13/90 text-[52px] text-white/60 duration-400 ease-in-out max-lg:scale-90"
                ></span>
                <div className="lg:max-w-[465px]">
                  <h3
                    className="md:text-is-heading-5 font-instrument-serif transition-color group-hover:text-background-13/90 text-[26px] font-normal text-white/80 mix-blend-color-burn duration-400 ease-in-out"
                  ...
                  <p
                    className="text-tagline-2 group-hover:text-background-13/60 transition-color font-normal text-white/60 mix-blend-color-burn duration-400 ease-in-out"
                  >
                    Design, copy, and creatives built for performance across
                    channels.
                  </p>
                </div>
              </div>
          ...
          >
            ...
            >
              ...
              <div className="relative z-20 flex gap-x-4 gap-y-2">
                <span
                  className="ns-shape-9 transition-color group-hover:!text-background-13/90 text-[52px] text-white/60 duration-400 ease-in-out max-lg:scale-90"
                ></span>
                <div className="lg:max-w-[465px]">
                  <h3
                    className="md:text-is-heading-5 font-instrument-serif transition-color group-hover:text-background-13/90 text-[26px] font-normal text-white/80 mix-blend-color-burn duration-400 ease-in-out"
                  ...
                  <p
                    className="text-tagline-2 group-hover:text-background-13/60 transition-color font-normal text-white/60 mix-blend-color-burn duration-400 ease-in-out"
                  >
                    Improve landing pages and funnels to increase leads and
                    sales.
                  </p>
                </div>
              </div>
  ...
  <span className="font-inter-tight text-tagline-4 text-background-13/70 text-white/50 font-normal">
    ...
    >
      ...
      >
        <a
          href="/team-details"
          className="bg-background-6 border-stroke-1/11 relative block h-full overflow-hidden rounded-lg border px-8 py-11 lg:rounded-none lg:rounded-l-lg"
        >
      ...
      <div className="partner-ship-card h-[420px] md:h-[333px]">
        <a
          href="/team-details"
          className="bg-background-6 border-stroke-1/11 relative block h-full overflow-hidden rounded-lg border-r px-8 py-11 lg:rounded-none"
        >
      ...
      <div className="partner-ship-card h-[420px] md:h-[333px]">
        <a
          href="/team-details"
          className="bg-background-6 relative block h-full overflow-hidden rounded-lg px-8 py-11 lg:rounded-none lg:rounded-r-lg"
        >
...
<section
  className="bg-background-6 !bg-background-5 !pt-20 md:!pt-30 lg:!pt-44 overflow-hidden py-14 md:py-20 lg:py-24 xl:py-28"
>
  <div className="main-container">
