import{i as e,n as t,r as n}from"./index-BB9Ue6_R.js";var r=e(n(),1),i=t(),a=`
...
`;function o(){return(0,r.useEffect)(()=>{let e=new IntersectionObserver(t=>{t.forEach(t=>{if(t.isIntersecting){let n=t.target.querySelector(`.ab-num`);if(n&&!n.classList.contains(`counted`)){n.classList.add(`counted`);let e=0;n.textContent=`0%`;let t=setInterval(()=>{e+=95/(1500/16),e>=95&&(e=95,clearInterval(t)),n.textContent=Math.floor(e)+`%`},16)}e.unobserve(t.target)}})},{threshold:.3}),t=document.querySelector(`.ab-card-1`);t&&e.observe(t);let n=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&e.target.classList.add(`ab-in`)})},{threshold:.1});return document.querySelectorAll(`.ab-reveal`).forEach(e=>n.observe(e)),()=>{e.disconnect(),n.disconnect()}},[]),(0,r.useEffect)(()=>{let e=document.querySelectorAll(`.count-num`),t=new IntersectionObserver(e=>{e.forEach(e=>{if(e.isIntersecting){let n=e.target,r=parseInt(n.getAttribute(`data-target`)),i=r/(2e3/16),a=0,o=setInterval(()=>{a+=i,a>=r&&(a=r,clearInterval(o)),n.textContent=Math.floor(a)},16);t.unobserve(n)}})},{threshold:.5});e.forEach(e=>t.observe(e));let n=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&e.target.classList.add(`st-in`)})},{threshold:.1});return document.querySelectorAll(`.st-card`).forEach(e=>n.observe(e)),()=>{t.disconnect(),n.disconnect()}},[]),(0,r.useEffect)(()=>{let e=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&e.target.classList.add(`sp-in`)})},{threshold:.1});return document.querySelectorAll(`.sp-item`).forEach(t=>e.observe(t)),()=>e.disconnect()},[]),(0,r.useEffect)(()=>{let e=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&e.target.classList.add(`t-in`)})},{threshold:.1});return document.querySelectorAll(`.t-card`).forEach(t=>e.observe(t)),()=>e.disconnect()},[]),(0,r.useEffect)(()=>{let e=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&e.target.classList.add(`w-in`)})},{threshold:.1});return document.querySelectorAll(`.w-card`).forEach(t=>e.observe(t)),()=>e.disconnect()},[]),(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(SEO,{title:`Our Team`,url:`/our-team`}),(0,i.jsx)(`style`,{children:a}),(0,i.jsxs)(`main`,{children:[(0,i.jsx)(`section`,{className:`ab`,children:(0,i.jsxs)(`div`,{className:`ab-wrap`,children:[(0,i.jsxs)(`div`,{children:[(0,i.jsxs)(`h2`,{className:`ab-h ab-reveal sd1`,children:[`How NexSas `,(0,i.jsx)(`span`,{children:`was born`})]}),(0,i.jsx)(`p`,{className:`ab-p ab-reveal sd2`,children:`NexSas was founded to make AI accessible for businesses. our tools are trusted globally for their simplicity, power, and real-world impact.`}),(0,i.jsxs)(`div`,{className:`ab-grid`,children:[(0,i.jsxs)(`div`,{className:`ab-card ab-card-1 ab-reveal sd3`,children:[(0,i.jsx)(`div`,{className:`ab-num`,children:`0%`}),(0,i.jsx)(`div`,{className:`ab-nl`,children:`Customer satisfaction rate`})]}),(0,i.jsxs)(`div`,{className:`ab-card ab-reveal sd4`,children:[(0,i.jsx)(`div`,{className:`ab-ct`,children:`Website design`}),(0,i.jsx)(`div`,{className:`ab-cx`,children:`Lorem ipsum dolor sit amet consectetur porta vel tempus molestie justo.`})]}),(0,i.jsxs)(`div`,{className:`ab-card pur ab-reveal sd5`,children:[(0,i.jsx)(`div`,{className:`ab-ct`,children:`Branding & identity`}),(0,i.jsx)(`div`,{className:`ab-cx`,children:`Lorem ipsum dolor sit amet consectetur porta vel tempus molestie justo.`})]}),(0,i.jsxs)(`div`,{className:`ab-card ab-reveal sd5`,children:[(0,i.jsxs)(`div`,{className:`avs`,children:[(0,i.jsx)(`img`,{className:`av-i`,src:`https://i.pravatar.cc/40?img=1`,alt:`a1`}),(0,i.jsx)(`img`,{className:`av-i`,src:`https://i.pravatar.cc/40?img=5`,alt:`a2`}),(0,i.jsx)(`img`,{className:`av-i`,src:`https://i.pravatar.cc/40?img=9`,alt:`a3`}),(0,i.jsx)(`img`,{className:`av-i`,src:`https://i.pravatar.cc/40?img=12`,alt:`a4`}),(0,i.jsx)(`div`,{className:`av-n`,children:`99+`})]}),(0,i.jsxs)(`div`,{className:`av-tx`,children:[`Timeless,`,(0,i.jsx)(`br`,{}),`sustainable`,(0,i.jsx)(`br`,{}),`creativity.`]})]})]})]}),(0,i.jsx)(`div`,{className:`ab-img ab-reveal from-right sd2`,children:(0,i.jsx)(`img`,{src:`/circuit.png`,alt:`circuit`})})]})}),(0,i.jsx)(`section`,{className:`st-sec`,children:(0,i.jsx)(`div`,{className:`st-grid`,children:[{icon:`✦`,title:`Relied upon by businesses`,num:20,suffix:`+`,label:`Experts`},{icon:`◎`,title:`The team at NexSaaS bank`,num:15,suffix:`+`,label:`Years Experience`},{icon:`⬡`,title:`Projects delivered globally`,num:500,suffix:`+`,label:`Projects`},{icon:`◈`,title:`Clients who trust NexSaaS`,num:100,suffix:`+`,label:`Clients`}].map((e,t)=>(0,i.jsxs)(`div`,{className:`st-card`,children:[(0,i.jsxs)(`div`,{className:`st-top`,children:[(0,i.jsx)(`div`,{className:`st-title`,children:e.title}),(0,i.jsx)(`div`,{className:`st-icon`,children:e.icon})]}),(0,i.jsxs)(`div`,{children:[(0,i.jsxs)(`div`,{className:`st-num-wrap`,children:[(0,i.jsx)(`span`,{className:`count-num`,"data-target":e.num,children:`0`}),(0,i.jsx)(`span`,{className:`st-suffix`,children:e.suffix})]}),(0,i.jsx)(`div`,{className:`st-label`,children:e.label})]})]},t))})}),(0,i.jsxs)(`section`,{className:`sp-sec`,children:[(0,i.jsxs)(`div`,{className:`sp-top`,children:[(0,i.jsx)(`span`,{className:`sp-tag`,children:`Steps`}),(0,i.jsx)(`h2`,{className:`sp-title`,children:`Get started in 3 simple steps`})]}),(0,i.jsx)(`div`,{className:`sp-grid`,children:[{num:`1`,title:`Sign up for free`,desc:`Try our services commitment-free! Explore all we offer without a credit card—it's a risk-free`},{num:`2`,title:`Customize your setup`,desc:`Customize Nexsas to perfectly align with the unique requirements of your business.`},{num:`3`,title:`Start scaling`,desc:`Streamline your processes, enhance efficiency, and expand your business horizons.`}].map((e,t)=>(0,i.jsxs)(`div`,{className:`sp-item`,children:[(0,i.jsx)(`div`,{className:`sp-num`,children:e.num}),(0,i.jsx)(`div`,{className:`sp-name`,children:e.title}),(0,i.jsx)(`p`,{className:`sp-desc`,children:e.desc})]},t))})]}),(0,i.jsxs)(`section`,{className:`t-sec`,children:[(0,i.jsxs)(`div`,{className:`t-top`,children:[(0,i.jsx)(`span`,{className:`t-tag`,children:`Our expert`}),(0,i.jsxs)(`h2`,{className:`t-title`,children:[`Driven by expertise.`,(0,i.jsx)(`br`,{}),`United by purpose.`]}),(0,i.jsx)(`p`,{className:`t-sub`,children:`Our team of AI specialists and strategists is committed to delivering intelligent, customized solutions that fuel your growth.`})]}),(0,i.jsx)(`div`,{className:`t-grid`,children:[{img:`https://i.pravatar.cc/400?img=11`,name:`James Park`,role:`AI Engineer`,featured:!1},{img:`https://i.pravatar.cc/400?img=12`,name:`Sophia Lee`,role:`Chief Technology Officer`,featured:!0},{img:`https://i.pravatar.cc/400?img=13`,name:`Aryan Mehta`,role:`Product Designer`,featured:!1},{img:`https://i.pravatar.cc/400?img=14`,name:`Carlos Rivera`,role:`ML Specialist`,featured:!1},{img:`https://i.pravatar.cc/400?img=15`,name:`David Osei`,role:`Backend Developer`,featured:!1},{img:`https://i.pravatar.cc/400?img=16`,name:`Kevin Yoon`,role:`Growth Lead`,featured:!1}].map((e,t)=>(0,i.jsxs)(`div`,{className:`t-card ${e.featured?`featured`:``}`,children:[(0,i.jsx)(`img`,{src:e.img,alt:e.name}),(0,i.jsx)(`div`,{className:`t-overlay`}),(0,i.jsxs)(`div`,{className:`t-info`,children:[(0,i.jsx)(`div`,{className:`t-bar`}),(0,i.jsx)(`div`,{className:`t-name`,children:e.name}),(0,i.jsx)(`div`,{className:`t-role`,children:e.role})]})]},t))})]}),(0,i.jsxs)(`section`,{className:`w-sec`,children:[(0,i.jsxs)(`div`,{className:`w-top`,children:[(0,i.jsx)(`span`,{className:`w-tag`,children:`Use cases`}),(0,i.jsx)(`h2`,{className:`w-title`,children:`Who It's For`}),(0,i.jsx)(`p`,{className:`w-sub`,children:`Whether you're optimizing blog content or building landing pages, Nexsas makes it easier to rank.`})]}),(0,i.jsx)(`div`,{className:`w-grid`,children:[{img:`https://i.pravatar.cc/400?img=47`,name:`Sarah Johnson`,role:`Content Creator`},{img:`https://i.pravatar.cc/400?img=48`,name:`Emily Chen`,role:`SEO Specialist`},{img:`https://i.pravatar.cc/400?img=49`,name:`Mia Tanaka`,role:`Landing Page Expert`},{img:`https://i.pravatar.cc/400?img=50`,name:`Sophia Lee`,role:`Blog Strategist`},{img:`https://i.pravatar.cc/400?img=44`,name:`Aisha Khan`,role:`Digital Marketer`}].map((e,t)=>(0,i.jsxs)(`div`,{className:`w-card`,children:[(0,i.jsx)(`img`,{src:e.img,alt:e.name}),(0,i.jsx)(`div`,{className:`w-overlay`}),(0,i.jsxs)(`div`,{className:`w-info`,children:[(0,i.jsx)(`div`,{className:`w-name`,children:e.name}),(0,i.jsx)(`div`,{className:`w-role`,children:e.role})]})]},t))})]})]})]})}export{o as default};